Vue.createApp({
    ...
    methods: {
        ...
        transfer: function () {
            ...
            axios.post(`/api/transactions?fromAccountNumber=${this.fromAccountNumber}&toAccountNumber=${this.accountToNumber}&amount=${this.amount}&description=${this.description}`, config)
                .then(response => {
                    this.modal.hide();
                    this.okmodal.show();
                })
        ...
        changedFrom: function () {
            if (this.trasnferType == "own") {
                this.clientAccountsTo = this.clientAccounts.filter(account => account.number != this.fromAccountNumber);
                this.accountToNumber = "VIN";
            }
        },
        finish: function () {
