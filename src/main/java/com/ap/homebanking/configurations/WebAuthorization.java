...
//
//                .antMatchers(HttpMethod.GET, "/api/clients/current","/api/accounts/{id}","/api/clients/current/accounts", "/api/transfers","/api/transactions", "/api/clients/current/cards", "/api/loans").hasAnyAuthority("CLIENT")
//
//                .antMatchers(HttpMethod.POST, "/api/clients/current/accounts", "/api/clients/current/cards","/api/loans","/api/transactions").hasAnyAuthority("CLIENT", "ADMIN")
//
